...
export default function ConfigurationProposalSuggestionPage() {
  ...
  console.log(configurationForm.values);
                  ...
                  <Grid gutter="xl" mt="md">
                      ...
                      <Group wrap="nowrap" gap="xs">
                        ...
                        <Tooltip label="Hapus file">
                          <ActionIcon
                            variant="subtle"
                            color="red"
                            onClick={() => openDeleteModal("template_proposal")}
                            disabled={
                              !configurationForm.values.template_proposal
                            }
                    ...
                    >
                      <Group wrap="nowrap" gap="xs">
                        <FileButton
                          onChange={(file) =>
                            handleFileUpload(file, "template_external_document")
                          }
                          accept="application/pdf"
                      ...
                      <Group wrap="nowrap" gap="xs">
                        ...
                        <Tooltip label="Hapus file">
                          <ActionIcon
                            variant="subtle"
                            color="red"
                            onClick={() => openDeleteModal("template_logbook")}
                            disabled={
                              !configurationForm.values.template_logbook
                            }
