...
export default function LecturerRankingPage() {
  ...
  const sortedScores = [...lecturers.map((g) => g._count.proposal_suggestion)].sort((a, b) => b - a);
                      ...
                      sections={[
                        {
                          ...
                          color: getBadgeColor(lecturer._count.proposal_suggestion, sortedScores),
                        },
                      ]}
                      label={
          ...
          <Table.Tbody>
            {filteredLecturers.map((lecturer, index) => (
              <Table.Tr key={lecturer.id}>
                ...
                <Table.Td>
                  <Badge color={getBadgeColor(lecturer._count.proposal_suggestion, sortedScores)}>
                    {getPerformanceLabel(lecturer._count.proposal_suggestion, sortedScores)}
                  </Badge>
                </Table.Td>
              </Table.Tr>
            ))}
