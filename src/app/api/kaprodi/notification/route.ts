...
export async function POST(req: NextRequest) {
    ...
    console.log(proposal_suggestion, status);
    ...
    try {
        ...
        formData.append('message', `Halo ${lecturer?.name}, ada pengajuan yang butuh persetujuan Anda di SIMLITABMAS. Status: ${status}`);
