...
export async function POST(req: NextRequest) {
    ...
    try {
        const lecturer = await lecturerService.getById(payload.lecturer_id);
        ...
        const lecturerUser = await userService.getFilteredUsers({ lecturer_id: payload.lecturer_id, user_type: payload.user_type });
