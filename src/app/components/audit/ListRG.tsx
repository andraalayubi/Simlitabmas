...
interface DaftarResearchGroupProps {
  researchGroups: ResearchGroup[];
}

const DaftarResearchGroup: React.FC<DaftarResearchGroupProps> = ({
  researchGroups,
}) => {
  ...
  return (
    <div className="bg-white shadow sm:rounded-lg p-6">
      ...
      <Modal
        ...
        title="Buat Research Group Baru"
      >
        <TextInput
