...
import NameTextEditor from "./Name";
import AbstractTextEditor from "./Abstract";
import BackgroundTextEditor from "./Background";
import MethodTextEditor from "./Method";
import PurposeTextEditor from "./Purpose";
import LiteratureReviewTextEditor from "./LiteratureReview";
import BibliographyTextEditor from "./Bibliography";
...
interface DaftarProposalProps {
  ...
  onChange: (
    field: keyof DaftarProposalProps["proposal"],
    value: string
  ) => void;
  onSubmit: (e: React.FormEvent) => void;
}

const DaftarProposal: React.FC<DaftarProposalProps> = ({
  proposal,
  onChange,
  onSubmit,
}) => {
